 ...
 */
public class frmVentaWhile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-665)/2, (screenSize.height-560)/2, 665, 560);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVentaWhile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVentaWhile().setVisible(true);
            }
        });
    }
