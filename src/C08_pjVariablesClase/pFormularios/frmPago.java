package C08_pjVariablesClase.pFormularios;
import javax.swing.DefaultListModel;
import javax.swing.JOptionPane;
import C08_pjVariablesClase.pClases.Planilla;
...
public class frmPago extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-592)/2, (screenSize.height-672)/2, 592, 672);
    ...
    void imprimeEstadisticas(){
        ...
        moEstadisticas.addElement("El Total de Gerente es: "+objP.getTotalGerentes());
        moEstadisticas.addElement("El Total de Administrativos es: "+objP.getTotalAdministrativo());
        moEstadisticas.addElement("El Total de Jefes es: "+objP.getTotalJefes());
        moEstadisticas.addElement("El Total de Operario es: "+objP.getTotalOperario());
        moEstadisticas.addElement("---------------------------------------------------------------------");
        moEstadisticas.addElement("Cantidad de empleados que ganan menos a $1200: "+objP.getTotalmenor1200());
        moEstadisticas.addElement("Cantidad de empleados que ganan entre $1200 y $2500: "+objP.getTotalEntre1200y2500());
        moEstadisticas.addElement("Cantidad de empleados que ganan mas de $2500: "+objP.getTotalmas2500());
    }
