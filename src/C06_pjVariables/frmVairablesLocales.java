 ...
 */
public class frmVairablesLocales extends javax.swing.JFrame {

    /**
     * Creates new form frmVairablesLocales
     */
    public frmVairablesLocales() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-368)/2, (screenSize.height-257)/2, 368, 257);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVairablesLocales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVairablesLocales().setVisible(true);
            }
        });
    }
